...
<section class="pagemid">
 ...
 <form class="form" method="post" action="<?=url::base(); ?>tutor/labs/edit">
                    <div class="sysform">
                    <table>
                        <tr><td><label for="tiitle">Название:</label></td></tr>
                        <tr>
                           
                            <td>
                                <input type="text" id="title"  size="70" name="title" value="<?=$labs->title;?>" />
                            </td>
                        </tr>
                         <tr>
                            <td width="150px" align="right">
                               ...
                               <select name="course_id">
                                    ...
                                    <option value="<?=$cat->id;?>" <?php if($cat->id == $labs->course_id) echo "selected" ;?> >
                                        <?=$cat->name;?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        ...
                        <tr>
                              ...
                              <div class="fulltextarea">
                                    <textarea name="condition" id="txt" rows="20" class="fulltextarea"><?=$labs->condition;?></textarea>
                    ...
                    <textarea name="answer" id="answer" rows="20" class="fulltextarea"><?=$labs->answer;?></textarea> 
                    <script type="text/javascript">
                ...
                indentUnit: 4                    // размер табуляции
                        ...
                        <tr>
                            <td colspan="3" >
                                <input type="hidden" id="id" name="id" value="<?=$labs->id;?>" />
