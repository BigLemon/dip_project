    ...
    <div id="wrapper">
        ...
        <header id="header">
            <div class="inner">
                ...
                <div class="menu">
                    <ul class="sf-menu">
                        <li><a href="<?php echo url::base(); ?>tutor/courses/">Управление курсами</a></li>
                        <li><a href="<?php echo url::base(); ?>tutor/tests/">Управление тестами</a></li>
                        <li><a href="<?php echo url::base(); ?>tutor/labs/">Управление лабами</a></li>
                        <li><a href="<?php echo url::base(); ?>tutor/rating/">Успеваемость студентов</a></li>
                    </ul>
                    <!-- end:sf-menu -->
                </div>
                <!-- menu -->
