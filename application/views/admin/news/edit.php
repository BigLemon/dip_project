    ...
    <div class="inner">
        ...
        <div id="main">
            <div class="entry-content">
                ...
                <form class="form" method="post" action="<?php echo url::base(); ?>admin/news/edit">
                        ...
                        <table>
                            ...
                            <tr>
                                <td colspan="3">
                                    ...
                                    <div class="fulltextarea">
                                        <textarea name="short" id="short" rows="20" class="fulltextarea"><?=$page->short;?></textarea>
                            ...
                            <tr>
                                <td colspan="3">
                                    Полная новость: <br />
                                    <div class="fulltextarea">
                                        <textarea name="fulltext" id="fulltext" rows="20" class="fulltextarea"><?=$page->fulltext;?></textarea>
                                        <script type="text/javascript" src="<?php echo url::base(); ?>ckeditor/ckeditor.js"></script>
